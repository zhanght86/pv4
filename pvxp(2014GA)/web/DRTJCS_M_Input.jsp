...
<div align="center">
<form name="DrtjMDeal_form" action="DrtjMCSDeal.do" target="pvmain" method="post" onsubmit="javascript:return dealFormSubmit();">
...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  ...
  <td>
    <font color=blue>PowerView XP </font>--- <font class="location">厂商故障率统计</font>
  </td>
...
<table width="100%" cellspacing="1" cellpadding="3" class="list_table_border">
  <tr align="center">
    <td class="list_td_title" colspan="4"><b>厂商故障率统计</b></td>
  </tr>
  <tr>
