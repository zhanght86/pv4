...
<html:html locale="true">
	...
	<body onload="javascript:parent.hidit();">
		<form name="InvState">
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><font color=blue>PowerView XP</font> --- <font class="location">发票状态查询</font></td>
				</tr>
			</table>

			<table border="0" width="100%" border="1" cellspacing="1" cellpadding="2" class="list_table_border">
				<tr>
					<td class="list_td_title" style="font: bold">发票状态查询</td>
				</tr>
				<tr>
					<td class="list_td_prom">您可以查询所选设备的当前发票状态以及剩余发票张数。</td>
				</tr>
			</table>
			...
			<table align="center" width="100%" cellspacing="1" cellpadding="3" border="0" class="list_table_border">
				<tr align="center">
					<td class="list_td_title" colspan="2">机构名称&nbsp;&nbsp;&nbsp;<app:bankselect property="bankid" onChange="InvState.submit()" defaultValue="<%=bankid%>" key="<%=mkey%>" keyValue="<%=mkeyvalue%>"/>
					...
					<app:devtpselect property="devtype" showName="1" key="pvxp.devtype.select.all" onChange="InvState.submit()"  defaultValue="<%=devtype%>"/></td>
		...
		<html:form action="/InvState.do" onsubmit="return confirmCheckBox(document.all.devno)">
			<%if (rows == 0) {%>
				<tr align="center">
