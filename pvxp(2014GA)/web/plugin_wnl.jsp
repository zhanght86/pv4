...
<app:checkPlugUser plugid="0000000001"/>
...
function drawCld(SY,SM) {
   ...
   if(SY>1874 && SY<1909) yDisplay = '    ' + (((SY)==1)?'元':SY)
   if(SY>1908 && SY<1912) yDisplay = '    ' + (((SY)==1)?'元':SY)
...
<BODY onload="parent.hidit();initial()">
<SCRIPT language=JavaScript><!--
...
document.write(date)
      ...
      style="FONT-SIZE: 9pt" onchange=changeTZ() name=TZ> <OPTION 
        value="+0800 北京、重庆、黑龙江" selected>北京</OPTION></SELECT>时间</FONT> <FONT 
      id=tSave 
