...
function dealFormSubmit(){
	...
	if( document.all.devlist != null ) {
	 ...
	 if (document.all.devip.value == "") {
        ...
        if (checkip(document.all.devip.value) == 1) {
          alert("输入的IP地址格式不完整");
          return false;
        }
...
<body onload="javascript:parent.hidit();">
	<div align="center">
		<table width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
					...
					<font class="location">远程设置</font>&nbsp;&nbsp;
					<a href="#"
						onClick="javascript:parent.parent.goUrl('NewsTrans.jsp');">消息发送</a>&nbsp;&nbsp;
					<a href="#"
						onClick="javascript:parent.parent.goUrl('DevMaint.jsp');">远程维护</a>
				</td>
			</tr>
		</table>
		...
		<table width="100%" cellspacing="1" cellpadding="2"
			...
			<html:form action="/IPRemote.do" method="post" styleId="DevReIP">
					...
					<td colspan="2">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="2">
							...
							<tr class="list_tr<%=i % 2%>">
								...
								<td width="20%">
									&nbsp;
									<input name="devlist" id="devlist" type="radio"
										value="<%=tmpdevno%>">
									&nbsp;
 ...
 %> </a>
							...
							<tr>
								...
								<td class="list_td_detail" colspan="4">
									<input type="text" name="devip" id="devip" size="30"
										maxlength="15">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
