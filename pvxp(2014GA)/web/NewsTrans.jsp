...
<body onload="javascript:parent.hidit();">
	<div align="center">
		...
		<table width="100%" cellspacing="1" cellpadding="2"
			...
			<html:form action="/NewsTrans.do" method="post" styleId="Newstrans">
 ...
 %> </a>
							...
							<tr>
								...
								<td class="list_td_detail" colspan="4">
									<input type="text" name="news" id="news" size="80"
										maxlength="150">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
