...
function dealFormSubmit(){
	...
	var devtime = document.all.devtime.value;
	if ( devtime==null || devtime=="" ) {
		alert ( "请输入终端重启关机时间！" );
		return false;
	}

	parent.showit();
	document.all['DevReboottime'].submit();
}
...
<body onload="javascript:parent.hidit();">
	<div align="center">
		...
		<table width="100%" cellspacing="1" cellpadding="2"
			...
			<html:form action="/DevReboot.do" method="post"
				styleId="DevReboottime">
 ...
 %> </a>
							...
							<tr>
								...
								<td class="list_td_detail" colspan="4">
									<input type="text" value="02:00:00" name="devtime" id="devtime"
										size="30">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<font color="red">(格式：02:00:00)</font>
								</td>
							</tr>
