...
<body onload="javascript:parent.hidit();">
	<div id="show" style="position:absolute; width="
		...
		<%
			...
			List list = ini.getValue("SPECCARD");
		...
		<table width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
					...
					<font class="location">特殊卡类型查询</font>
				</td>
			</tr>
		</table>
		...
		<table cellspacing="1" cellpadding="3" class="list_table_border"
			width="100%">
			<html:form action="/specialCardDelete.do"
				onsubmit="return confirmDelete(specialCardList)">
				<tr align="center">
					<td class="list_td_title" width="8%">
						卡类型标识
					</td>
					...
					<td width="18%" class="list_td_title">
						<img src="images/default/bt_add.gif" style="cursor:hand"
							id="iniCardTypeAdd"
							onclick="parent.parent.goUrl('iniSpecialCardAdd.jsp')">
						<html:image src="images/default/bt_delete.gif" />
						&nbsp;
						<img src="images/default/bt_selectall.gif" style="cursor:hand"
							id="btn_selectAll"
							onclick="toggleSelectAll(document.all.btn_selectAll, document.all.specialCardList)">
					</td>
				</tr>
				<%
					//卡类型标示|卡类型|说明
				...
				<tr align="left" class="list_tr<%=i % 2%>">
					<td align="center" width="8%">
						&nbsp;
						<b><a href="#"
							onclick="javascript:parent.parent.goUrl('iniSpecialCardModify.jsp?key=<%=oneCardType[0]%>')"><%=cardTypeArray[0]%>
						</a> </b>
					</td>
					<td>
						&nbsp;
					...
					<td>
						&nbsp;
						<%=myUtil.file2gb(cardTypeArray[8])%>
					</td>
					<td align="center">
						<input name="specialCardList" type="checkbox"
							value="<%=oneCardType[0]%>" />
					</td>
				</tr>
				<%
