...
function dealFormSubmit(){
	...
	parent.showit();
	document.all['DevRemotept'].submit();
}
...
<body onload="javascript:parent.hidit();">
	<div align="center">
		<table width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
					...
					<font class="location">终端重启关机标志修改</font>
					<%
					if (authlist.equals("*")) {
					%>
					<a href="#"
		...
		<table width="100%" cellspacing="1" cellpadding="2"
			...
			<html:form action="/DevRemote.do" method="post" styleId="DevRemotept">
 ...
 %> </a>
							...
							<tr>
								...
								<td class="list_td_detail" colspan="4">
									&nbsp;
									<input type="radio" name="devopt" id="devopt" value="1" checked>
									重启&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="devopt" id="devopt" value="2">
									关机&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
