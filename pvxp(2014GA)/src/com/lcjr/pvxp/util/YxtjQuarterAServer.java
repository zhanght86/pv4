 ...
 * 
 */
public class YxtjQuarterAServer extends Thread {

	Logger log = Logger.getLogger("web.lcjr.pvxp.util.YxtjQuarterAServer.java");
	...
	public YxtjQuarterAServer() {

	}

	public void run() {

		log.info("自 设备总体运行情况统 季 开始");
		...
		try {
			...
			try {
				 ...
				 * myTjMonth.getDevno().trim(); iflag = 0; for( int j=0;
