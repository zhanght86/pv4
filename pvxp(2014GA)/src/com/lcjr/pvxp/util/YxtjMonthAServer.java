 ...
 * 
 */
public class YxtjMonthAServer extends Thread {

	Logger log = Logger.getLogger("web.lcjr.pvxp.util.YxtjMonthAServer.java");
	...
	public YxtjMonthAServer() {

	}

	public void run() {
		// 进入主线程
		log.info("自 设备总体运行情况统 月 开始");
		try {
