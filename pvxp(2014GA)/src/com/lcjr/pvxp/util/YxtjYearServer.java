 ...
 * 
 */
public class YxtjYearServer extends Thread {
	
	Logger log = Logger.getLogger("web.lcjr.pvxp.util.YxtjYearServer.java");
	...
	public void run() {
		...
		try {
			...
			try {
				 ...
				 * myTjYear.getDevno().trim(); iflag = 0; for( int j=0; j<devnoArray.size();
