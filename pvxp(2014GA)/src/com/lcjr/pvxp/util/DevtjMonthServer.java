 ...
 * 
 */
public class DevtjMonthServer extends Thread {
	
	Logger log = Logger.getLogger("web.lcjr.pvxp.util.DevtjMonthServer.java");
	...
	public void run() {
		...
		try {
			...
			// wukp20120307 统计设备通讯故障时长,排除设备通讯时间
			...
			try {
				...
				// 记录文件
				String filename = "M_03_" + operid + "_" + DateTimeStr + ".htm";
				...
				// 更新系统任务表
				myStaMission = (StaMission) myStaMissionModel.getOneStaMission(DateTimeStr, "03", "M", operid);
