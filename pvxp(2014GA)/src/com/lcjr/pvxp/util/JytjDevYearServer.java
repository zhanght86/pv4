 ...
 * @time 2012-03-26
 */
public class JytjDevYearServer extends Thread {
	
	Logger log = Logger.getLogger("web.lcjr.pvxp.util.JytjDevYearServer.java");
		...
		try {
			...
			try {
				...
				if (devnoList.size() == 0) {
					...
					// 表体
					int[] devTotalnum = new int[devnoList.size()];
					// double[] devTotalprice = new double[devnoList.size()];
