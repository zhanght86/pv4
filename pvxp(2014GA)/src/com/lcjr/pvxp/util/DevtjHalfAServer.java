...
public class DevtjHalfAServer extends Thread {

	Logger log = Logger.getLogger("web.lcjr.pvxp.util.DevtjHalfAServer.java");
	...
	public DevtjHalfAServer() {

	}

	public void run() {
		// 进入主线程
		log.info("自 设备故障统计 半年 开始..");
		try {
			...
			try {
				...
				outstr.append("\t\t\t<font class='location'>(半年报)\n");
