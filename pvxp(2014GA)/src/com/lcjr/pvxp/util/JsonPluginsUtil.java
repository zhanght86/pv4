...
public class JsonPluginsUtil {
	 ...
	 * @return 返回json的字符串
	 */
	public static JSON strToJson(String xml) {
	...
	public static String jsonToXml(String jsonString) {
		...
		returnMsg = new XMLSerializer().write(jobj);
