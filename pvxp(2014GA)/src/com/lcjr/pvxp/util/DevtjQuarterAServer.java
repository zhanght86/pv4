 ...
 * 
 */
public class DevtjQuarterAServer extends Thread {
	
	Logger log = Logger.getLogger("web.lcjr.pvxp.util.DevtjQuarterAServer.java");
	...
	public void run() {
		...
		try {
			...
			try {
				...
				String tmpdate = nowdate.substring(4, 6);
				String tmpyear = Integer.toString(Integer.parseInt(nowdate.substring(0, 4)) + 1);
				...
				outstr.append("\t\t\t<font class='location'>(季报)\n");
