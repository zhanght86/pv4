...
public class IniDeleteSpecialCardAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		SpecialCardDeleteForm areaForm = (SpecialCardDeleteForm) form;
		String[] specialCard = areaForm.getSpecialCardList();
		ini.remove("SPECCARD", specialCard);
		try{
			ini.write();
			myForward=mapping.findForward("iniSpecialCardDeleted");
