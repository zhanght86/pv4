...
import com.lcjr.pvxp.actionform.DevRemoteForm;
 ...
 * <br>
 * <p>
 * <b>Description:</b> 终端重启标志修改Action
 * </p>
 * <br>
 * <p>
 ...
 */
public final class DevRemoteAction extends Action {

	Logger log = Logger.getLogger(DevRemoteAction.class.getName());

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		log.error("execute开始");
		MessageResources messages = getResources(request);
		ActionMessages errors = new ActionMessages();
		String devlist[] = (String[]) ((DevRemoteForm) form).getDevlist();
		String devopt = (String) ((DevRemoteForm) form).getDevopt().trim();
		...
		try {
			...
			try {
				...
				for (int i = 0; i < devlist.length; i++) {
					...
					// 处理请求报文
					sendpack = "0026../ini/Mcs.ini|Time|ShutDown|" + devopt;
