...
import com.lcjr.pvxp.actionform.BankinfoModifyShowForm;
 ...
 * <br>
 * <p>
 * <b>Description:</b> 机构修改显示信息Action
 * </p>
 * <br>
 * <p>
 ...
 */
public final class BankinfoModifyShowAction extends Action {

	Logger log = Logger.getLogger(BankinfoModifyShowAction.class.getName());

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {

		log.info("execute开始");
		ActionMessages errors = new ActionMessages();
		String mybankid = (String) ((BankinfoModifyShowForm) form).getBankid();
		...
		try {
			...
			myforward = mapping.findForward("Bankinfo_ModifyShow");
		} catch (Exception e) {
			log.error("execute", e);
