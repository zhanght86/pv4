 ...
 */
public final class JytjDevMInputAction extends Action {

	Logger log = Logger.getLogger(JytjDevMInputAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			myforward = mapping.findForward("JytjDevMInput");
		} catch (Exception e) {
