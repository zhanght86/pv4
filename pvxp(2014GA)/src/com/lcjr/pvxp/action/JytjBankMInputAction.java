 ...
 */
public final class JytjBankMInputAction extends Action {

	Logger log = Logger.getLogger(JytjBankMInputAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			myforward = mapping.findForward("JytjBankMInput");
		} catch (Exception e) {
