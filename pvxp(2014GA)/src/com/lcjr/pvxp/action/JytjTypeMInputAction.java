 ...
 */
public final class JytjTypeMInputAction extends Action {

	Logger log = Logger.getLogger(JytjTypeMInputAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			myforward = mapping.findForward("JytjTypeMInput");
		} catch (Exception e) {
