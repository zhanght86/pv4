...
import com.lcjr.pvxp.actionform.OperModifyShowForm;
 ...
 * <p><b>Description:</b> 操作员修改显示信息Action</p><br>
 * <p><b>Copyright:</b> Copyright (c) 2005</p><br>
 * <p><b>Company:</b> 浪潮金融事业部(LCJR)</p><br>
 * @author 刘太沛
 * @version 1.0 2005/2/26
 */
public final class OperModifyShowAction extends Action{

	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{

		MessageResources messages = getResources(request);
		ActionMessages errors = new ActionMessages();
		String myoperid = (String)((OperModifyShowForm) form).getOperid().trim();
		...
		try{
			...
			myforward = mapping.findForward("Operator_ModifyShow");
		}catch(Exception e){
