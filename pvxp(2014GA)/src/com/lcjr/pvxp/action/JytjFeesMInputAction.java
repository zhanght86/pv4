 ...
 */
public final class JytjFeesMInputAction extends Action {

	Logger log = Logger.getLogger(JytjFeesMInputAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			myforward = mapping.findForward("JytjFeesMInput");
		} catch (Exception e) {
