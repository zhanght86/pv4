 ...
 * <p><b>Description:</b> 插件添加ActionForm</p><br>
 * <p><b>Copyright:</b> Copyright (c) 2005</p><br>
 * <p><b>Company:</b> 浪潮金融事业部(LCJR)</p><br>
 * @author 杨旭
 * @version 1.0 2005/03/30
 */
public final class SystemPluginAddForm extends ActionForm {
	...
	public ActionErrors validate(ActionMapping mapping , HttpServletRequest request) {
		...
		try{
			...
			if( tmp!=null ){
				...
				errors.add("plugid", new ActionMessage("pvxp.syssetup.plugin.hasExist",plugid));
			}
		}catch(Exception e){}
		return errors;
	}
